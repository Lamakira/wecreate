...
export function HeroSection({ hero }: HeroSectionProps) {
  return (
    <section className="relative flex min-h-[92vh] flex-col justify-end overflow-hidden px-gutter pt-[clamp(28px,6vw,80px)] pb-section-xs">
      <div
        aria-hidden="true"
      ...
      <div className="relative max-w-hero animate-wc-fade">
